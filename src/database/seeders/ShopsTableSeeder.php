...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image_url' => 'https://rese-bucke.s3.ap-northeast-1.amazonaws.com/sushi.jpg',
        ];
        ...
        $param = [
            ...
            'image_url' => 'https://rese-bucke.s3.ap-northeast-1.amazonaws.com/yakiniku.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://rese-bucke.s3.ap-northeast-1.amazonaws.com/izakaya.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://rese-bucke.s3.ap-northeast-1.amazonaws.com/italian.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://rese-bucke.s3.ap-northeast-1.amazonaws.com/ramen.jpg',
        ];
        DB::table('shops')->insert($param);
